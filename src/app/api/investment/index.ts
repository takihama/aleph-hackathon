...
const wallet = ethers.Wallet.fromPhrase(
  "art audit grunt doctor average liquid hen slab mesh jacket winter column"
).connect(provider);
...
export const allocateFunds = async (mantleAddress: string, token: TokenType, amount: string): Promise<void> => {
...
export const deInvestFunds = async (mantleAddress: string): Promise<void> => {
  // TODO: Implement
  return;
}; 
